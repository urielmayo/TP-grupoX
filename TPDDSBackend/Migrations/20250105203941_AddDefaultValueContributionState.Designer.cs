...
namespace TPDDSBackend.Migrations
{
    ...
    [Migration("20250105203941_AddDefaultValueContributionState")]
    partial class AddDefaultValueContributionState
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TPDDSBackend.Domain.Entities.BenefitCoefficients", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal>("ActiveFridges")
                        .HasColumnType("numeric");

                    b.Property<DateTime>("CreatedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<decimal>("DeliveredCards")
                        .HasColumnType("numeric");

                    b.Property<decimal>("DeliveredFoods")
                        .HasColumnType("numeric");

                    b.Property<decimal>("DonatedFoods")
                        .HasColumnType("numeric");

                    b.Property<decimal>("DonatedPesos")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("TPDDSBackend.Domain.Entities.CommunicationMedia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TPDDSBackend.Domain.Entities.FridgeIncident", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("FridgeIncident");
            ...
            modelBuilder.Entity("TPDDSBackend.Domain.Entities.FridgeOpening", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("FridgeOpenings");
                });

            modelBuilder.Entity("TPDDSBackend.Domain.Entities.FridgeSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("AvailableFoodsQuantity")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("CommunicationMediaId")
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("FullFoodsQuantity")
                        .HasColumnType("integer");

                    b.Property<bool?>("IncidentSubscription")
                    ...
                    b.HasIndex("CommunicationMediaId");

                    b.HasIndex("FridgeId");

                    b.ToTable("FridgeSubscriptions");
                });

            modelBuilder.Entity("TPDDSBackend.Domain.Entities.SubscriptionMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TPDDSBackend.Domain.Entities.TechnicianVisit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("FridgeRepaired")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                    ...
                    b.Property<Guid>("UuidToComplete")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UuidToComplete")
                        .IsUnique();

                    b.ToTable("TechnicianVisits");
                });

            modelBuilder.Entity("TPDDSBackend.Domain.Entities.VisitXTechnician", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("TechnicianVisitId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TechnicianVisitId");

                    b.ToTable("VisitXTechnicians");
                });
            ...
            modelBuilder.Entity("TPDDSBackend.Domain.Entities.FridgeAlert", b =>
                {
                    b.HasBaseType("TPDDSBackend.Domain.Entities.FridgeIncident");

                    b.Property<string>("Type")
                        .IsRequired()
                        .HasColumnType("text");

                    b.HasDiscriminator().HasValue("FridgeAlert");
                });
            ...
            modelBuilder.Entity("TPDDSBackend.Domain.Entities.VulnerablePersonCard", b =>
                {
                    b.HasBaseType("TPDDSBackend.Domain.Entitites.Contribution");
                    ...
                    b.HasDiscriminator().HasValue("VulnerablePersonCard");
                });
            ...
            modelBuilder.Entity("TPDDSBackend.Domain.Entitites.FridgeOwner", b =>
                {
                    ...
                    b.ToTable("Contributions", t =>
                        {
                            t.Property("FridgeId")
                                .HasColumnName("FridgeOwner_FridgeId");
                        });
            ...
            modelBuilder.Entity("TPDDSBackend.Domain.Entities.CollaboratorCard", b =>
                {
                    b.HasOne("TPDDSBackend.Domain.Entities.Card", "Card")
                        .WithOne()
                        .HasForeignKey("TPDDSBackend.Domain.Entities.CollaboratorCard", "CardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TPDDSBackend.Domain.Entitites.Collaborator", "Collaborator")
                        .WithOne()
                        .HasForeignKey("TPDDSBackend.Domain.Entities.CollaboratorCard", "CollaboratorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TPDDSBackend.Domain.Entities.FridgeSubscription", b =>
                {
                    ...
                    b.HasOne("TPDDSBackend.Domain.Entities.CommunicationMedia", "CommunicationMediaDesired")
                        .WithMany()
                        .HasForeignKey("CommunicationMediaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("CommunicationMediaDesired");
            ...
            modelBuilder.Entity("TPDDSBackend.Domain.Entities.SubscriptionMessage", b =>
                {
                    b.HasOne("TPDDSBackend.Domain.Entities.CommunicationMedia", "CommunicationMedia")
                        .WithMany()
                        .HasForeignKey("CommunicationMediaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CommunicationMedia");
                });
            ...
            modelBuilder.Entity("TPDDSBackend.Domain.Entities.TechnicianVisit", b =>
                {
                    ...
                    b.HasOne("TPDDSBackend.Domain.Entitites.Technician", "Technician")
                        .WithMany()
            ...
            modelBuilder.Entity("TPDDSBackend.Domain.Entities.VisitXTechnician", b =>
                {
                    ...
                    b.HasOne("TPDDSBackend.Domain.Entities.TechnicianVisit", "TechnicianVisit")
                        .WithMany()
                        .HasForeignKey("TechnicianVisitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Technician");

                    b.Navigation("TechnicianVisit");
                });
            ...
            modelBuilder.Entity("TPDDSBackend.Domain.Entities.VulnerablePersonCard", b =>
                {
                    b.HasOne("TPDDSBackend.Domain.Entities.Card", "Card")
                        .WithOne()
                        .HasForeignKey("TPDDSBackend.Domain.Entities.VulnerablePersonCard", "CardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TPDDSBackend.Domain.Entitites.PersonInVulnerableSituation", "Owner")
                        .WithOne()
                        .HasForeignKey("TPDDSBackend.Domain.Entities.VulnerablePersonCard", "PersonInVulnerableSituationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
